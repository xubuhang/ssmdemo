...
public class SendMailUtils {
    ...
    public static String personal = "大和系统";


    public static void sendMail(String receiveMailAccount,String nickname,String subject,String context) throws Exception {
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, myEmailAccount, receiveMailAccount,nickname,subject,context);
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail
      , String nickname,String subject,String context) throws Exception {
        // 1. 创建邮件对象
        ...
        message.addRecipient(RecipientType.TO, new InternetAddress(receiveMail, nickname, "UTF-8"));
